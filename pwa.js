...
const cacheName = 'LA5MauraSmall-2021-09-22 14:08:41.755406'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LA5MauraSmall'.length) === 'LA5MauraSmall') {
